    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link me-2" href="courses">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5 text-center mx-auto">
                    ...
                    <p class="text-lead text-white">ND COURSES</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card z-index-0">
                    ...
                    <div class="card-body">
                        <form method="post">
                            ...
                            <p class="text-sm mt-3 mb-0">Bạn chưa có tài khoản? <a href="sign_up" class="text-dark font-weight-bolder">Đăng ký</a></p>
                        </form>
                    </div>
                </div>
            </div>
